...
PetscErrorCode set_temperature_from_solution(Ctx *, Vec);
PetscErrorCode set_temperature_reconstruction_from_ctx(Ctx *, PetscScalar);
PetscErrorCode set_solution_from_temperature(Ctx *, Vec);

...
typedef enum
{
  MO_ATMOSPHERE_TYPE_GREY_BODY = 1,
  MO_ATMOSPHERE_TYPE_ZAHNLE,
  MO_ATMOSPHERE_TYPE_VOLATILES,
  MO_ATMOSPHERE_TYPE_HEAT_FLUX,
  MO_ATMOSPHERE_TYPE_TEMPERATURE
} MagmaOceanAtmosphereType;
typedef enum
{
  OXYGEN_FUGACITY_NONE = 0,
  OXYGEN_FUGACITY_CI,
  OXYGEN_FUGACITY_CV,
  OXYGEN_FUGACITY_H,
  OXYGEN_FUGACITY_EH,
  OXYGEN_FUGACITY_EUCRITE,
  OXYGEN_FUGACITY_FISCHER_IW,
  OXYGEN_FUGACITY_ONEILL_IW
} OxygenFugacityType;
typedef struct
{
  // input parameters
...
typedef enum
{
  MO_CORE_TYPE_COOLING = 1,
  MO_CORE_TYPE_HEAT_FLUX,
  MO_CORE_TYPE_TEMPERATURE
} MagmaOceanCoreType;
typedef struct
{
  ...
  PetscScalar ic_adiabat_temperature; // temperature at top of adiabat
  PetscScalar ic_surface_temperature; // initial temperature at surface
  PetscScalar ic_core_temperature;    // initial temperature at core-mantle boundary
  PetscScalar ic_dTdr;

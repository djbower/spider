...
PetscScalar get_steam_atmosphere_zahnle_1988_flux( const Atmosphere *, const Constants );
...
PetscErrorCode set_reservoir_volatile_content( Atmosphere *, const AtmosphereParameters *, const Constants );

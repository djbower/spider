...
def solid_evolution_fig3( times ):
    ...
    yticks = [1.0E18,1.0E19,1.0E20,1.0E21,1.0E22,1.0E23]
...
#====================================================================
def solid_evolution_fig4( times ):

    logger.info( 'building solid_evolution_fig4' )

    fig_o = su.FigureData( 2, 2, 4.7747, 4.7747, 'solid_evolution_fig4', times )
...
#====================================================================
def solid_evolution_fig5( times ):

    logger.info( 'building solid_evolution_fig5' )

    # keep y the same by scaling (7.1621)
    fig_o = su.FigureData( 3, 2, 4.7747, 7.1621, 'solid_evolution_fig5', times )
...
def main():
    ...
    if not (args.fig3 or args.fig4 or args.fig5):
        args.fig3 = True;
        args.fig4 = True;
        args.fig5 = True;
    ...
    if args.fig4 :
        solid_evolution_fig4( times=args.times )
    if args.fig5 :
        solid_evolution_fig5( times=args.times )

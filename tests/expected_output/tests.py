...
def atmosphere(rootDir) :
  ...
  launch = [\
          os.path.join(rootDir,'spider')  + ' -options_file ' + os.path.join(rootDir,'examples','unit_tests','atmosphere','bu_input.opts'),\
...
def atmosphere_jeans(rootDir) :
  ...
  launch = [\
          os.path.join(rootDir,'spider')  + ' -options_file ' + os.path.join(rootDir,'examples','unit_tests','atmosphere_jeans','bu_input.opts'),\
          os.path.join(rootDir,'tests','copy_one_of.py') + ' ' + acceptable_files + ' -o to_check.json',\
          os.path.join(rootDir,'tests','json_timestep_to_txt.py to_check.json'),
          #os.path.join(rootDir,'tests','timeout.sh') + ' -t 6 ' + os.path.join(rootDir,'py3','plot_spider.py') + ' -t 0,100,200,400,800,1200,1500',\
          ]
...
def blackbody(rootDir) :
  ...
  ranks = 1
  launch = [\
          os.path.join(rootDir,'spider')  + ' -options_file ' + os.path.join(rootDir,'examples','unit_tests','blackbody','bu_input.opts'),\
          os.path.join(rootDir,'tests','json_timestep_to_txt.py output/100.json'),
          #os.path.join(rootDir,'tests','timeout.sh') + ' -t 6 ' + os.path.join(rootDir,'py3','plot_spider.py') + ' -t 0,100,200,400,800,1200,1500',\
          ]

  expectedFile = os.path.join(thisDir,'expected_blackbody.txt')
...
def blackbody_init_liquid(rootDir) :
  ...
  ranks = 1
  launch = [\
          os.path.join(rootDir,'spider')  + ' -options_file ' + os.path.join(rootDir,'examples','unit_tests','blackbody','bu_input.opts') + ' -ic_adiabat_entropy 2700' + ' -nstepsmacro 0',\
  ...
  expectedFile = os.path.join(thisDir,'expected_blackbody_init_liquid.txt')
...
def blackbody_init_mixed(rootDir) :
  ...
  ranks = 1
  launch = [\
          os.path.join(rootDir,'spider')  + ' -options_file ' + os.path.join(rootDir,'examples','unit_tests','blackbody','bu_input.opts') + ' -ic_adiabat_entropy 1900' + ' -nstepsmacro 0',\
          os.path.join(rootDir,'tests','json_timestep_to_txt.py'),
          #os.path.join(rootDir,'tests','timeout.sh') + ' -t 6 ' + os.path.join(rootDir,'py3','plot_spider.py') + ' -t 0',\
          ]

  expectedFile = os.path.join(thisDir,'expected_blackbody_init_mixed.txt')
...
def blackbody_init_solid(rootDir) :
  ...
  ranks = 1
  launch = [\
          os.path.join(rootDir,'spider')  + ' -options_file ' + os.path.join(rootDir,'examples','unit_tests','blackbody','bu_input.opts') + ' -ic_adiabat_entropy 1100' + ' -nstepsmacro 0',\
          os.path.join(rootDir,'tests','json_timestep_to_txt.py'),
          #os.path.join(rootDir,'tests','timeout.sh') + ' -t 6 ' + os.path.join(rootDir,'py3','plot_spider.py') + ' -t 0',\
          ]

  expectedFile = os.path.join(thisDir,'expected_blackbody_init_solid.txt')

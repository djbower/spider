...
typedef struct _Solution {
    ...
    Vec alpha, alpha_mix, cond, cp, cp_mix, dfusdr, dfusdr_temp, dphidr, dSdr, dSliqdr, dSsoldr, dTdPs, dTdPs_mix, dTdrs, dTdrs_mix, Etot, fusion, fusion_curve, fusion_curve_temp, fusion_rho, fusion_temp, gsuper, Jcond, Jconv, Jgrav, Jmix, Jtot, kappah, liquidus, liquidus_rho, liquidus_temp, nu, phi, rho, S, solidus, solidus_rho, solidus_temp, temp, visc;

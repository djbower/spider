...
Therefore:
\begin{equation}
P_s = (1+\epsilon) P_{H_2} + P_{He} = P_{H_2}^\ast + P_{He}
\end{equation}
where $P_{H_2}^\ast$ is the effective partial pressure of H$_2$ taking account of reactions.  This must relate directly to the number of moles of H$_2$ in the atmosphere $x_{H_2}$:
\begin{equation}

...
K = 
    ...
    \end{dcases}
\end{equation}
Whichever value of $x$ gives $Q=K$ determines the amount that the concentrations will change in the timestep. The value of $x$ is usually a partial pressure, which must be converted to a mass fraction. 

...
\begin{equation}
\frac{\partial m_B}{\partial t} = \frac{b \mu_B}{a \mu_A} \left( \frac{p_B}{p_A} \frac{\partial m_A}{\partial t} + \frac{m_A}{p_A} \frac{\partial p_B}{\partial t} + (-1)\frac{p_B m_A}{{p_A}^2} \frac{\partial p_A}{\partial t} \right)
\end{equation}
%%%%
%%%%
%%%%
...
\end{equation}
\paragraph{Reaction quotient: reactions}

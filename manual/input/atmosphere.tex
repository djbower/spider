...
K = 
    ...
    \end{dcases}
\end{equation}
Whichever value of $x$ gives $Q=K$ determines the amount that the concentrations will change in the timestep. The value of $x$ will be a partial pressure, which must be converted to a mass fraction. The relationship between the partial pressure of a volatile added or subtracted due to chemical reactions and its mass evolution is: 
\boxedeq{}{\frac{dm_{\rm v}^r}{dt} = \plusminus C_{\rm v}\frac{x}{P_{T}} \frac{\mu_{\rm v}}{\mu_{T}}M^l }

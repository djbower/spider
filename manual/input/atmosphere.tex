...
\end{equation}
We can compute the \dbnote{arithmetic or geometric?} average of Eq.~\ref{eq:Keq_fO2_OS19} over the surface temperature range from 500 to 4000 K to eliminate $T_s$ \dbnote{is this what you do?  Note that we don't have to eliminate $T_s$ since we know if from the code}:

...
\end{equation}
But now express in terms of the entropy change at the CMB:
\begin{equation}
\frac{dQ_c}{dt} = m_c c_c \hat{T}_{core} \frac{T_{cmb}}{c_{cmb}} \frac{dS_{cmb}}{dt} = -A_{cmb} J_{cmb} = -E_{cmb}
\end{equation}
\begin{equation}
S_{cmb} = S_{-1} + \frac{\Delta r}{2} \left( \left. \frac{dS}{dr} \right |_{cmb} \right)
\end{equation}
Since $\Delta r$ and $dS/dr$ are negative.  Therefore:
\begin{equation}
...
\end{equation}
\begin{equation}
\left( \frac{dS_{-1}}{dt} + \frac{\Delta r}{2} \frac{d}{dt} \left( \left. \frac{dS}{dr} \right |_{cmb} \right)  \right) = -E_{cmb} \frac{c_{cmb}}{c_c} \frac{1}{m_c \hat{T}_{core} T_{cmb}}
\end{equation}
\begin{equation}
\frac{\Delta r}{2} \frac{d}{dt} \left( \left. \frac{dS}{dr} \right |_{cmb} \right) = -E_{cmb} \frac{c_{cmb}}{c_c} \frac{1}{m_c \hat{T}_{core} T_{cmb}} - \frac{dS_{-1}}{dt}
\end{equation}
\begin{equation}
\frac{\Delta r}{2} \frac{d}{dt} \left( \left. \frac{dS}{dr} \right |_{cmb} \right) = -E_{cmb} \frac{c_{cmb}}{c_c} \frac{1}{m_c \hat{T}_{core} T_{cmb}} - \frac{(Eout_{-1}+Ein_{-1}+H_{-1})}{\rho T V}
\end{equation}
Now, $Ein_{-1}=E_{cmb}$.  Also $Eout_{-1}$ and $H_{-1}$ are both known since they lie exclusively in the magma ocean domain.  In the magma ocean, $E_{cmb}$ can be computed for known $S_{cmb}$ and $dS/dr|_{cmb}$ (given by initial condition to start with).  Crucially, this will enable us to cut off gravitational separation as soon as the CMB drops below the solidus.
%%%
\subsubsection{Isothermal (constant entropy)}
